...
export class ScoreCardComponent implements OnInit {
  ...
  firstBatsmanBall;
  secondBatsmanBall;
  strikeRateOfFirstBatsman;
  strikeRateOfSecondBatsman;
  constructor(private team1: Players1Service, private team2: Player2Service, private match: MatchService, totalRunsWick: TotalScoreWicketService, batsman1: BatsmanDetailService) {
   ...
   this.batsname2=batsman1.batsman2;
   this.runsof2=batsman1.runs2;
   this.firstBatsmanBall=batsman1.firstBatsmanBall;
   this.secondBatsmanBall=batsman1.secondBatsmanBall;
   this.strikeRateOfFirstBatsman=this.runsof1/this.firstBatsmanBall*100;
   this.strikeRateOfSecondBatsman=this.runsof2/this.secondBatsmanBall*100;
   // console.log(+this.runsof1);
    ...
    // if (this.numofovers == this.match.maTch[0].overs && this.bowlingTeam == this.team1.playears1) {
    //   this.bowlingTeam = this.team2.playears2;
    //   this.battingTeam = this.team1.playears1;
    //   this.numofovers = 0;
     
    // }

    // else if (this.numofovers == this.totalovers && this.bowlingTeam == this.team2.playears2) {
    //   this.bowlingTeam = this.team1.playears1;
    //   this.battingTeam = this.team2.playears2;
    // }
  }
  teamnameChange()
  {
    console.log("Team Name Cahnge");
  }
  ngOnInit() {
  }
