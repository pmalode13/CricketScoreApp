...
export class SummaryComponent implements OnInit {
  ...
  @ViewChild('secondBatsman') secondBatsmanInTs: ElementRef;
  fieldingTeam;
  playt1;
  playt2;
  tosswin;
  ...
  onSelectOfBowler()
  {
    this.bowlerName=(<HTMLInputElement>this.bowlerNameInTs.nativeElement).value;
  }

  onSelectOfFirstBatsman()
  {
    this.batsman1=(<HTMLInputElement>this.firstBatsmanInTs.nativeElement).value;
  }

  onSelectOfSecondBatsman()
  {
    
    this.batsman2=(<HTMLInputElement>this.secondBatsmanInTs.nativeElement).value;
  }
  onAddScoreClick() {
    this.ballnum++;
    ...
    this.batsmandetail.batsman1D(this.batsman1  ,(<HTMLInputElement>this.possiblerunInTS.nativeElement).value,this.batsman2);
